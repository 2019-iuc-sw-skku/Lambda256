...
public class n_send1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bot = findViewById(R.id.send2bot);
        top=findViewById(R.id.send2top1);
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(n_send1.this, g_MainScreen.class);
        ...
        bell.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Intent intent = new Intent(n_send1.this, h_mypage1.class);
                //startActivityForResult(intent, 1);
            }
        });
        ...
        Send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(n_send1.this, i_sendfirst.class);
                startActivityForResult(intent, 1);
            }
        });
        ...
        Purchase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(n_send1.this, j_giftmain.class);
                startActivityForResult(intent, 1);
            }
        });
        ...
        Inform.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(n_send1.this, k_infomain.class);
                startActivityForResult(intent, 1);
            }
        });
