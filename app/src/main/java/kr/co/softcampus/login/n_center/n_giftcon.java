...
public class n_giftcon extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bot = findViewById(R.id.giftconbot);
        top=findViewById(R.id.giftcontop1);
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(n_giftcon.this, g_MainScreen.class);
        ...
        bell.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Intent intent = new Intent(n_giftcon.this, h_mypage1.class);
                //startActivityForResult(intent, 1);
            }
        });
        ...
        textView48.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(n_giftcon.this, n_giftcon1.class);
                startActivityForResult(intent, 1);
            }
        });
        ...
        Send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(n_giftcon.this, i_sendfirst.class);
                startActivityForResult(intent, 1);
            }
        });
        ...
        Purchase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(n_giftcon.this, j_giftmain.class);
                startActivityForResult(intent, 1);
            }
        });
        ...
        Inform.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(n_giftcon.this, k_infomain.class);
                startActivityForResult(intent, 1);
            }
        });
